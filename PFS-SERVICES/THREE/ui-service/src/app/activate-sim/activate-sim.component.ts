...
export class ActivateSimComponent {
  ...
  constructor(private mobilePlanService: MobilePlanService, private authService: AuthService, private router: Router, public sharedDataService: SharedDataService, private toast: NgToastService) {}
